...
$CONFIG = '{"lang":"fr","error_reporting":false,"show_hidden":true,"hide_Cols":true,"calc_folder":false}';
/**
...
define('PMV', '1.0');
//Application Title
define('APP_TITLE', 'Gestionnaire de fichiers PolFM');
...
$favicon_path = '/static/logos/main-full.png';
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> PolFM <?php echo PMV; ?>~tinyfilemanager@<?php echo VERSION; ?></a></h3>
                    </p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">PolFM <?php echo PMV; ?>~tinyfilemanager-<?php echo VERSION; ?></a></div>
        <?php else: ?>
        <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">PolFM <?php echo PMV; ?>~tinyfilemanager-<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
<?php
...
<html>
    <head>
        ...
        <style>
            :root {
                --font-family-sans-serif: "Ubuntu", -apple-system, "Segoe UI", "Roboto", "Oxygen", "Cantarell", "Fira Sans", "Droid Sans", "Helvetica Neue", sans-serif !important;
            }
            body {
                background: transparent !important;
            }
    ...
    ?>
        ...
        <script>
            ...
            editor.session.setOption("useSoftWraps", true);
            ...
            $(function() {
                ...
                document.querySelector("select#js-ace-mode").value = "ace/mode/<?php echo $ext; ?>";
