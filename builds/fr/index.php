...
<head>
    ...
    <title>Intégration en continu Minteck Projects</title>
    <script>location.href = "#";</script>
</head>
<body>
    <?php $data = json_decode(file_get_contents("../data.json")); ?>
    <header>
        <span id="title">Tâches</span>
        <span id="status">
            <div id="gstatus-loader">
                <img src="loader-dark.svg" alt="Patientez..." width="36px" height="36px" id="gstatus-loader-img">
            </div>
        </span>
    </header>
    ...
    <article>
        <div id="states">
            <div id="states-loader">
                <img src="loader.svg" alt="Patientez..." width="36px" height="36px" id="states-loader-img">
            </div>
        </div>
        <div id="log">
            <div id="log-inner">
                <div id="log-welcome">
                    <h1 class="log-title">
                        <img src="welcome.svg" width="32px" height="32px" alt="" class="log-welcome-logo"> Bienvenue
                    </h1>
                    <div id="log-welcome-content"></div>
                    <div id="welcome-loader">
                        <img src="loader.svg" alt="Patientez..." width="36px" height="36px" id="welcome-loader-img">
                    </div>
                </div>
                <div id="log-logs" style="display:none;">
                    <h1 class="log-title">
                        <img src="logs.svg" width="32px" height="32px" alt="" class="log-logs-logo"> Fichier journal de <span id="log-job">Tâche inconnue</span>
                    </h1>
                    <div id="log-loader">
                        <img src="loader.svg" alt="Patientez..." width="36px" height="36px" id="log-loader-img">
                    </div>
                    <div id="log-file" style="display:none;">Patientez...</div>
                </div>
            </div>
        </div>
    </article>
    ...
    <script>
        ...
        setInterval(() => {
            document.getElementById('status').innerHTML = `<div id="gstatus-loader"><img src="loader-dark.svg" alt="Patientez..." width="36px" height="36px" id="gstatus-loader-img"></div>`;
            setTimeout(() => {
                $.ajax("?states", {
                    cache: false,
                    success: (data) => {
