...
! function(e) {
        ...
        for (;;) {
            ...
            switch (e.charAt(E + 1)) {
                case "/":
                    ...
                    if (O)
                        for (var M in O) r.endPrefixMapping(M);
                    k++;
                    break;
                case "?":
                    h && a(E), k = x(e, E, r);
    ...
    function y(e, t, n) {
        ...
        if (e.closed) {
            t.endElement(d, h, r);
            if (i)
                for (c in i) t.endPrefixMapping(c)
    ...
    function $(e, t) {
        ...
        if (e = e.firstChild)
            do
                if ($(e, t)) return !0; while (e = e.nextSibling)
    }
    ...
    function Z(e, t, n) {
        ...
        do i.parentNode = e; while (i !== s && (i = i.nextSibling));
