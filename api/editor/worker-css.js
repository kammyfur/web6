...
! function(e) {
    ...
    function() {
                ...
                t, n = {
                    ...
                    _media_expression: function() {
                        var e = this._tokenStream,
                            t = null,
                            n, r = null;
                        return e.mustMatch(Tokens.LPAREN), this._readWhitespace(), t = this._media_feature(), this._readWhitespace(), e.match(Tokens.COLON) && (this._readWhitespace(), n = e.LT(1), r = this._expression()), e.mustMatch(Tokens.RPAREN), this._readWhitespace(), new MediaFeature(t, r ? new SyntaxUnit(r, n.startLine, n.startCol) : null)
                    },
        ...
        Pseudos.ELEMENT = 1, Pseudos.CLASS = 2, Pseudos.isElement = function(e) {
            ...
            function u(e) {
                var t, n, r, a, f = e.elementName ? e.elementName.text : "",
                    l;
    ...
    var CSSLint = function() {
        ...
        return r.version = "@VERSION@", r.addRule = function(t) {
            ...
            var s = 0,
                o, u, a, f = new parserlib.css.Parser({
                    starHack: !0,
                    ieFilters: !0,
                    underscoreHack: !0,
                    strict: !1
    ...
    Reporter.prototype = {
            ...
            init: function(e, t) {
                ...
                function a() {
                    ...
                    if (!o) {
                        if (s.height)
                            for (e in i) i.hasOwnProperty(e) && s[e] && (u = s[e].value, (e !== "padding" || u.parts.length !== 2 || u.parts[0].value !== 0) && t.report("Using height with " + e + " can sometimes make elements larger than you expect.", s[e].line, s[e].col, n));
                        if (s.width)
                            for (e in r) r.hasOwnProperty(e) && s[e] && (u = s[e].value, (e !== "padding" || u.parts.length !== 2 || u.parts[1].value !== 0) && t.report("Using width with " + e + " can sometimes make elements larger than you expect.", s[e].line, s[e].col, n))
                    }
                }
                var n = this,
                    r = {
                    ...
                    for (a in e)
                        if (e.hasOwnProperty(a)) {
                            ...
                            if (c.length > h.length)
                                for (s = 0, o = c.length; s < o; s++) p = c[s], CSSLint.Util.indexOf(h, p) === -1 && (d = h.length === 1 ? h[0] : h.length === 2 ? h.join(" and ") : h.join(", "), t.report("The property " + p + " is compatible with " + d + " and should be included as well.", l.actualNodes[0].line, l.actualNodes[0].col, n))
                        }
                })
            }
        }), CSSLint.addRule({
