connerr = new Audio("/lib/kiki/connect.ogg");
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.ASSUME_ES5 = !1;
...
goog.base = function(a, b, c) {
    ...
    g = !1;
    for (var l = a.constructor.prototype; l; l = Object.getPrototypeOf(l))
        if (l[b] === d) g = !0;
        else if (g) return l[b].apply(a, f);
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$DomHelper_DomHelper.prototype.addUserRequestNode = function(a) {
    ...
    new Audio("/lib/kiki/sent.ogg").play();
    b.innerHTML = a;
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$DomHelper_DomHelper.DEFAULT_EMPTY_NODE_CONTENT = "<img src=\"/lib/kiki/kiki.svg\" width=\"23px\" height=\"17px\">";
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.prototype.handleResponse = function(a, b) {
    ...
    new Audio("/lib/kiki/received.ogg").play();
    setTimeout(function() {
        ttsAuto(a.id)
    }, 250);
...
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.API_URL = "https://mprj-cors-proxy.herokuapp.com/https://console.dialogflow.com/api-client/demo/embedded/minteck-projects-kiki/demoQuery";
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.DEFAULT_ERROR = "Aucune connexion";
module$contents$google3$third_party$apiai$ui$legacy$src$main$webapp$js$agentDemoApp$App_App.DEFAULT_NO_ANSWER = " ";
